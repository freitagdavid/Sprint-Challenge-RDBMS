...
RDBMS is a data storage standard whereas sql is a language that some rdbmses use to access their data.

1. Why do tables need a `primary key`?

It makes each row uniquely identifiable
...
A third table that acts as a binder between the other two.
